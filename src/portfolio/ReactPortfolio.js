                ...
                <div className='flex flex-col justify-center items-center backdrop-filter backdrop-blur-sm w-5/6 bg-[#B026FF]/50 h-auto p-18 mt-20'>
                    <div className='flex flex-row justify-center items-center h-full w-full pl-20 pr-20'>
                        <Collapsible trigger="Task 1: INTRO" className="">
                            <div class="flex flex-col justify-center items-center">
                                <span class="text-5xl text-zinc-200 font-mono inline-block align-middle mb-8">
                                    WHAT IS THIS MISSION?
                                </span>
                            </div>
                            <div class="self-center">
                                <span class="text-4xl text-zinc-200 font-mono inline-block align-middle mb-12">
                            ...
                            <div className="flex flex-col justify-center content-center items-center">
                                <div className="ml-28">
                                    <div class="flex items-center mb-4">
                                        <input id="default-checkbox" type="checkbox" value="" class="mr-4 w-8 h-8 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                        <label for="default-checkbox" class="ml-2 text-4xl font-medium text-gray-900 dark:text-gray-300">Dynamic Item Cards</label>
                                    </div>
                                    <div class="flex items-center mb-4">
                                        <input id="default-checkbox" type="checkbox" value="" class="mr-4 w-8 h-8 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                        <label for="default-checkbox" class="ml-2 text-4xl font-medium text-gray-900 dark:text-gray-300">Two filtering categories</label>
                                    </div>
                                    <div class="flex items-center mb-4">
                                        <input id="default-checkbox" type="checkbox" value="" class="mr-4 w-8 h-8 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                        <label for="default-checkbox" class="ml-2 text-4xl font-medium text-gray-900 dark:text-gray-300">Sorting</label>
                                    </div>
                                    <div class="flex items-center mb-4">
                                        <input id="default-checkbox" type="checkbox" value="" class="mr-4 w-8 h-8 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                        <label for="default-checkbox" class="ml-2 text-4xl font-medium text-gray-900 dark:text-gray-300">Filtering/sorting combinations</label>
                                    </div>
                                    <div class="flex items-center mb-4">
                                        <input id="default-checkbox" type="checkbox" value="" class="mr-4 w-8 h-8 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                        <label for="default-checkbox" class="ml-2 text-4xl font-medium text-gray-900 dark:text-gray-300">Item aggregation with removal</label>
                                    </div>
                                    <div class="flex items-center mb-8">
                                        <input id="default-checkbox" type="checkbox" value="" class="mr-4 w-8 h-8 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                        <label for="default-checkbox" class="ml-2 text-4xl font-medium text-gray-900 dark:text-gray-300">Reset filtering/sorting</label>
                                    </div>
                                </div>
                            </div>
                        </Collapsible>
                    ...
                    <div className='flex flex-row justify-center items-center h-full w-full pl-20 pr-20'>
                        <Collapsible trigger="Task 2: MISSION STRATEGY" className="">
                            <div className="flex flex-col justify-center items-center">
                                ...
                                <div class="flex flex-col justify-center items-center">
                                    <span class="text-4xl text-zinc-200 font-mono inline-block align-middle mb-8 italic">
                                        how sad and bad and mad it was - but then, how it was sweet  <br />
                                        - Robert Browning
                                    </span>
                                </div>
                                <div class="flex flex-col justify-center items-center">
                                    <span class="text-4xl text-zinc-200 font-sans inline-block text-left mb-16 pl-12 pr-12">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-col justify-center content-center items-center">
                                            <div className="ml-28">
                                                <div class="flex items-center mb-4">
                                                    <input id="default-checkbox" type="checkbox" value="" class="mr-4 w-8 h-8 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                                    <label for="default-checkbox" class="ml-2 text-4xl font-medium text-gray-900 dark:text-gray-300">Furniture item cards with prices</label>
                                                </div>
                                                <div class="flex items-center mb-4">
                                                    <input id="default-checkbox" type="checkbox" value="" class="mr-4 w-8 h-8 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                                    <label for="default-checkbox" class="ml-2 text-4xl font-medium text-gray-900 dark:text-gray-300">Filter on furniture type and rarity</label>
                                                </div>
                                                <div class="flex items-center mb-4">
                                                    <input id="default-checkbox" type="checkbox" value="" class="mr-4 w-8 h-8 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                                    <label for="default-checkbox" class="ml-2 text-4xl font-medium text-gray-900 dark:text-gray-300">Sort on price</label>
                                                </div>
                                                <div class="flex items-center mb-4">
                                                    <input id="default-checkbox" type="checkbox" value="" class="mr-4 w-8 h-8 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                                    <label for="default-checkbox" class="ml-2 text-4xl font-medium text-gray-900 dark:text-gray-300">Online store style cart</label>
                                                </div>
                                                <div class="flex items-center mb-4">
                                                    <input id="default-checkbox" type="checkbox" value="" class="mr-4 w-8 h-8 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                                    <label for="default-checkbox" class="ml-2 text-4xl font-medium text-gray-900 dark:text-gray-300">Aggregate cart total on price</label>
                                                </div>
                                                <div class="flex items-center mb-8">
                                                    <input id="default-checkbox" type="checkbox" value="" class="mr-4 w-8 h-8 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                                    <label for="default-checkbox" class="ml-2 text-4xl font-medium text-gray-900 dark:text-gray-300">Stardew Valley themed UI</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className='flex flex-row justify-center items-center h-full w-full pl-20 pr-20'>
                        <Collapsible trigger="Task 3: WAR WITH REACT" className="">
                            <div className="flex flex-col justify-center items-center">
                                <div class="flex flex-col justify-center items-center">
                                    <span class="text-5xl text-zinc-200 font-mono inline-block align-middle mb-16 ">
                                        The development process was a challenging, yet rewarding battle.
                                    </span>
                                </div>
                                <div class="flex flex-col justify-center items-center">
                                    <span class="text-4xl text-zinc-200 font-mono inline-block text-left mb-8 pl-12 pr-12">
                        ...
                        <Collapsible trigger="Task 4: DEMO" className="">
                            <div className="flex flex-col justify-center items-center">
                                <div className="flex flex-col justify-center items-center">
                                    ...
                                    <div class="flex flex-row justify-center mb-10 mt-8 px-8 py-8 bg-emerald-400 border-4 border-white rounded-full hover:bg-emerald-200">
                                        <a class="font-sans text-3xl underline text-[#3366CC]" href="https://fortnitebattlepass123.github.io/uiux-development/" target="_blank" rel="noopener noreferrer">Visit the Website!</a>
                                    </div>
                                </div>
                            </div>
                        </Collapsible>
